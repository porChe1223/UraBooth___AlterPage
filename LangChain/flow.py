...
class State(TypedDict, total=False):
    message_type: Optional[str]   #ツール名を格納
    messages: Optional[str]       #ユーザの質問を格納
...
# ノードの追加
child_builder1 = StateGraph(State)
...
# ノードの追加
child_builder2 = StateGraph(State)
...
# ノードの追加
child_builder3 = StateGraph(State)
